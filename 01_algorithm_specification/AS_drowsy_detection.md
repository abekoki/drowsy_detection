...
| --- | --- | --- | --- | --- |
| left_eye_close_threshold | 左目の開眼度がこの値以下で閉眼と判定 | **0.10** | 0.0 | 1.0 |
| right_eye_close_threshold | 右目の開眼度がこの値以下で閉眼と判定 | **0.10** | 0.0 | 1.0 |
...
| 2025-08-26 | 1.0.5 | 検知感度パラメータ調整：左右目閉眼閾値を0.30→0.10、顔検出閾値を0.70→0.75に変更 | GPT-Assist |
